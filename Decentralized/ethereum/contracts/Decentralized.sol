...
contract Factory{
    ...
    function userSignUp (bytes32 hash) public{
        require(user[hash] == 0x0);
        address newUser=new userInstance(msg.sender);
        user[hash] =newUser ;
    }
    
    function  nodeSignIn(bytes32  hash ,string  ipAddress) public  returns(bytes32){
        require(node[hash] !=0x0);
...
contract userInstance{
    ...
    function setFileDetailsOfPart1_2(string filename,string part1_1,string part1_2
    ,string part1_3,string part2_1,string part2_2,string part2_3)public{
    ...
    function setFileDetailsOfPart3(string filename,string part3_1,string part3_2
    ,string part3_3)public{
    ...
    function userInstance (address creator)public{
