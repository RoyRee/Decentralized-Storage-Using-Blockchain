...
class LoginForm extends Component{
  ...
  componentDidMount(){
		document.body.style.backgroundImage = "url('https://www.netpremacy.com/wp-content/uploads/2018/09/Background-website-01.jpg')";
	}
...
onSubmit = async () =>{
  ...
  console.log(bytes);
      ...
      if(address != null){
      Router.pushRoute(`/userInstances/${address}/HomePage`);
      }else{
  ...
  <Head>
    ...
    <Grid textAlign='center' style={{ height: '90%' }} verticalAlign='middle'>
      ...
      <Grid.Column style={{ maxWidth: 450 }}>
        ...
        <Message>
          New to us? <a href='/userSignUp'>Sign Up </a><br />  Node Login <a href='/nodeLogin'>click here</a>
